...
<head>
    ...
    <title>Emilio Caraballo Castro | Portfolio</title>
</head>
...
<body>
    ...
    <header>
        <div class="wave">
            <div class="container header-container">
                <h1 class="name">Emilio Caraballo Castro.</h1>
                <h3 class="subtitle text-center">Data analyst and Visualization Specialist with Mathematics Background.</h3>
    ...
    <section class="container">
        ...
        <h3 class="subtitle">I am an enthusiastic software engineer with a passion for data management and visualization
            using python technologies with Pandas and NumPy between others. </h3>
    </section>
    ...
    <section class="container">
        <div class="card custom-card">
            <div class="card-body">
                ...
                <p class="card-text">
                    Excel, VBA, Python, Conda, Git, Jupyter, HTML, Flask, PostgreSQL
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="container education-container">
        ...
        <article class="education-item">
            ...
            <span class="text-muted">Data Analyst and Visualization | Jun 2021 - Nov 2021</span>
        </article>
        <hr />
        <article class="education-item">
            <h3 class="subtitle">LabFour Education</h3>
            <span class="text-muted">MCTS | Nov 2017 - Jan 2018</span>
        </article>
		<article class="education-item">
            <h3 class="subtitle">University of Pinar del Rio</h3>
            <span class="text-muted">BSc. computer Engineering | Sep 2005 - Jun 2011</span>
        </article>
        <hr />
    </section>
    ...
    <footer>
        <div class="container">
            Emilio Caraballo Castro &copy; 2017 - 2021 |
